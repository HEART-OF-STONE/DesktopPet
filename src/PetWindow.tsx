...
export function PetWindow() {
  ...
  return <div className="desktop-pet">
    ...
    <div className="desktop-character" onContextMenu={e=>{e.preventDefault();void desktopAction('settings');}}
      ...
      <PetRenderer pack={pack} skin={skin} action={companion.action} sequence={companion.sequence} size={256*snapshot.preferences.scale} pressed={pressed} onRegions={report}/>
    </div>
